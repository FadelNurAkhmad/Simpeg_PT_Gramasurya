...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Form <small>Edit Jatah Cuti <i class="fa fa-angle-right"></i> <i class="fa fa-key"></i> Pegawai: <?= $peg['nama'] ?> &nbsp;&nbsp;<i class="fa fa-lock"></i> NIP : <?= $peg['nip'] ?></small></h1>
<!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
    <div class="col-md-12">
            ...
            <div class="panel-body">
                <form action="index.php?page=edit-jatah-cuti&id_jatah=<?= $id_jatah ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Periode Jatah Cuti</label>
                        <div class="col-md-3">
