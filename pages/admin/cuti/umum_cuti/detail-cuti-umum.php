...
<div class="invoice">
    <div class="invoice-company">
        <span class="pull-right hidden-print">
            ...
            <a href="../../pages/superadmin/cuti/umum_cuti/print-cuti-umum.php?id_cuti_umum=<?= $id_cuti_umum ?>" target="_blank" title="print" class="btn btn-sm btn-success m-b-10"><i class="fa fa-print"></i> &nbsp;Print</a>
        </span>
        Detail Cuti Pegawai
    </div>
