...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Riwayat Pendidikan <small><i class="fa fa-angle-right"></i> Bahasa <i class="fa fa-angle-right"></i> Insert&nbsp;</small></h1>
<!-- end page-header -->
<?php
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form master data bahasa</h4>
			</div>
