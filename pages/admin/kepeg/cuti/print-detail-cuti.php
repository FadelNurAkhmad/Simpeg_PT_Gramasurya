...
$pdf->SetFont('helvetica', '', 10);
	...
	list($y1,$m1,$d1)	=explode ("-",$data['tgl_mulai']);
	list($y2,$m2,$d2)	=explode ("-",$data['tgl_selesai']);
	list($y3,$m3,$d3)	=explode ("-",$data['tgl_suratcuti']);
...
$sign = '<table cellpadding="1" border="0" align="center">
			<tr>
				<td width="200"></td>
				<td width="100"></td>
				<td width="285">'.$setsek['kab'].', '.$d3.' '.$m3.' '.$y3.'</td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				<td></td>
				<td></td>
				<td><font size="9" style="text-transform:uppercase;font-weight:bold;">An. BUPATI '.$setsek['kab'].'</font></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
