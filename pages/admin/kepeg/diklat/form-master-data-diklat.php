...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Kepegawaian <small><i class="fa fa-angle-right"></i> Diklat <i class="fa fa-angle-right"></i> Insert&nbsp;</small></h1>
<!-- end page-header -->
<?php
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form master data diklat</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=master-data-diklat&id_diklat=<?= $id_diklat ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="diklat" maxlength="128" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Jumlah Jam</label>
						<div class="col-md-6">
							<input type="text" name="jml_jam" maxlength="4" class="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="angkatan" maxlength="4" class="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input type="text" name="no_sttpp" maxlength="32" class="form-control" />
						</div>
						<div class="col-md-3">
							<div class="input-group date" id="datepicker-disabled-past1" data-date-format="yyyy-mm-dd">
								<input type="text" name="tgl_sttpp" class="form-control" />
