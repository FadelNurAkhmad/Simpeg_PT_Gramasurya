...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Kepegawaian <i class="fa fa-angle-right"></i> <small><i class="fa fa-angle-right"></i> Latihan Jabatan <i class="fa fa-angle-right"></i> Insert&nbsp;</small></h1>
<!-- end page-header -->
<?php
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form master data latihan jabatan</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=master-data-lat-jabatan&id_lat_jabatan=<?= $id_lat_jabatan ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="nama_pelatih" maxlength="64" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Tahun</label>
						<div class="col-md-6">
							<input type="text" name="tahun_lat" maxlength="4" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Jumlah Jam</label>
						<div class="col-md-6">
							<input type="text" name="jml_jam" maxlength="3" class="form-control" />
						</div>
					</div>
					<div class="form-group">
