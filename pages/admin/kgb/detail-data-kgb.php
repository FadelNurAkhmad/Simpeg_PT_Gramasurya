...
<div class="invoice">
	<div class="invoice-company">
		<span class="pull-right hidden-print">
			...
			<a href="../../pages/admin/kgb/print-detail-kgb.php?id_spkgb=<?=$id_spkgb?>" target="_blank" title="print" class="btn btn-sm btn-success m-b-10"><i class="fa fa-print"></i> &nbsp;Print</a>
		</span>
