...
<div class="row">
	<div class="col-md-12">
		<div class="alert alert-success fade in m-b-15">
			<strong></span> <i class="fa-lg fa fa-check text-success"></i> &nbsp;Welcome To SIMPEG</strong>. Aplikasi Sistem Informasi Manajemen Kepegawaian. Dikembangkan oleh <a href="http://www.qelopak.com/">Qelopak Teknologi Indonesia</a> | IT Consultant | <i class="fa-lg ion-ios-telephone"></i> (0251) 8474192<span class="close" data-dismiss="alert">&times;</span>
		</div>
	</div>
</div>
<!-- begin row -->
