...
$subhead = '<table border="0" cellspacing="0" cellpadding="3">
			<tr>
				<td width="585" align="center"><font size="10"><b>Rekapitulasi Pegawai Berdasarkan Unit Kerja</b></font></td>	
			</tr>
		</table><br /><br />';
...
$html = '<table border="1" cellspacing="0" cellpadding="3">
			<tr align="center">
				...
				<td width="380"><b>UNIT KERJA</b></td>	
...
$pdf->Output('Rekap_Unit Kerja_' . date("Ymd") . '.pdf', 'I');
