...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">KPI <small>Divisi Perusahaan <i class="fa fa-angle-right"></i> Edit <i class="fa fa-key"></i> id_<?= $id_divisi_kpi ?></small></h1>
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form Divisi Perusahaan</h4>
			</div>
