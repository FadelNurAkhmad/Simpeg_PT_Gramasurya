    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Form master data gaji jabatan</h4>
            </div>
            <div class="panel-body">
                <form action="index.php?page=master-data-gaji-jabatan&id_jabatan=<?= $id_jabatan ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
