...
$html = '<table border="0" cellspacing="0" cellpadding="3">
			...
			<tr>
				...
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['gaji_pokok'] . '</td>
			</tr>
			<tr>
				<td width="3%">&nbsp;</td>
				<td width="53%"><b>Tunjangan Tetap</b></td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['tunjangan_tetap'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Struktural</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['struktural'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Pendidikan</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['pendidikan'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Keahlian</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['keahlian'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Penyesuaian</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['penyesuaian'] . '</td>
			</tr>
			<tr>
				<td width="3%">&nbsp;</td>
				<td width="53%"><b>Tunjangan Variabel</b></td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['tunjangan_variabel'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Presensi</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['presensi'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Uang Makan</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['uang_makan'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
				<td width="23%">Kehadiran</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['kehadiran'] . '</td>
			</tr>
			<tr>
				<td width="12%">&nbsp;</td>
			...
			<tr>
				...
				<td width="23%">Anak</td>
				<td width="5%">:</td>
				<td width="30%">Rp. ' . $data['anak'] . '</td>
			</tr>
			<tr>
				<td width="45%">&nbsp;</td>
				<td width="30%">Jumlah</td>
				<td width="5%">:</td>
				<td width="20%">Rp. ' . $jumlah_total . '</td>
			</tr>
			<tr>
				<td width="3%">&nbsp;</td>
			...
			<tr>
				<td width="50%">&nbsp;</td>
				<td width="25%">Jumlah Gaji Diterima</td>
				<td width="5%">:</td>
				<td width="20%">Rp. ' . $data['gaji_diterima'] . '</td>
			</tr>
		</table>
