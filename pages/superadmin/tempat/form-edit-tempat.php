...
if (isset($_GET['id_lokasi'])) {
    ...
    $query   = mysqli_query($koneksi, "SELECT * FROM tb_tempat WHERE id_lokasi='$id_lokasi'");
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Form <small>Edit Lokasi <i class="fa fa-angle-right"></i> <i class="fa fa-key"></i> Pegawai: <?= $peg['nama'] ?> &nbsp;&nbsp;<i class="fa fa-lock"></i> NIP : <?= $peg == 0 ? '-' : $peg['pegawai_nip']; ?></small></h1>
<!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
    <div class="col-md-12">
