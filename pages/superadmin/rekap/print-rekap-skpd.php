...
$pdf->SetFont('helvetica', '', 10);
	...
	$namakep		=mysqli_fetch_array($namakepala, MYSQLI_ASSOC);
...
$sign = '<table cellpadding="1" border="0" align="center">
			...
			<tr>
				<td></td>
				<td></td>
				<td align="center"><font size="9"><b>'.$namakep['nama'].'</b></font></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
			...
			<tr>
				<td></td>
				<td></td>
				<td align="center"><font size="9"><b>NIP. '.$namakep['nip'].'</b></font></td>
			</tr>
		</table>';
$pdf->writeHTML($sign, true, false, false, false, '');

//Close and output PDF document
$pdf->Output('Rekap_SKPD_'.date("Ymd").'.pdf', 'I');
