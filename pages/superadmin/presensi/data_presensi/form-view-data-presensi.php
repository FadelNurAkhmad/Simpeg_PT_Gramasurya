...
<ol class="breadcrumb pull-right">
    ...
    <li><a href="index.php?page=form-master-data-presensi" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-plus-circle"></i> &nbsp;Tambah Jadwal Kerja Pegawai</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" align="center">
                                            <a href="index.php?page=delete-data-presensi&pegawai_id=<?= $peg['pegawai_id'] ?>" class="btn btn-danger">&nbsp; &nbsp;YES&nbsp; &nbsp;</a>
                                        </div>
