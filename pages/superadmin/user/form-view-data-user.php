...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Master Setup <small><i class="fa fa-angle-right"></i> Admin&nbsp;</small></h1>
<!-- end page-header -->
<?php
include "../../config/koneksi.php";
$tampilUsr	= mysqli_query($koneksi, "SELECT * FROM tb_user WHERE hak_akses!='Pegawai' ORDER BY hak_akses");
?>
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
