...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Jenis Cuti <i class="fa fa-angle-right"></i> Edit <i class="fa fa-key"></i> id_<?= $id_jenis ?></small></h1>
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form edit data Jenis Cuti</h4>
			</div>
