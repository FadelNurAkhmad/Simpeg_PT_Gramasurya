...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Approval <small> <i class="fa fa-angle-right"></i> Approval Tahap 2&nbsp;</small></h1>
<!-- end page-header -->
<?php
include "../../config/koneksi.php";

// ambil data gabungan tabel pegawai dan tb_approval_cuti_tahunan (Cuti Tahunan)
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active in" id="cuti_tahunan">
                <div class="alert alert-success fade in">
                    ...
                    <i class="fa fa-info fa-2x pull-left"></i> Folder ini dapat digunakan untuk melihat data approval cuti tahap 2 ...
                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#Approve<?php echo $cuti['id_approval_cuti'] ?>" title="Approve"><i class="fa fa-check"> </i> Approve</a>
                                        <a type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#Reject<?php echo $cuti['id_approval_cuti'] ?>" title="Reject"><i class="fa fa-close"> </i> Reject</a>
                                        <a type="button" class="btn btn-success btn-icon btn-sm" data-toggle="modal" data-target="#Detail<?php echo $cuti['id_approval_cuti'] ?>" title="detail"><i class="fa fa-folder-open-o fa-lg"></i></a>
                                        <!-- <a type="button" class="btn btn-info btn-icon btn-sm" href="index.php?page=form-edit-cuti&id_approval_cuti=<?= $cuti['id_approval_cuti'] ?>" title="edit"><i class="fa fa-pencil fa-lg"></i></a> -->
                                        <!-- <a type="button" class="btn btn-danger btn-icon btn-sm" data-toggle="modal" data-target="#Del<?php echo $cuti['id_approval_cuti'] ?>" title="delete"><i class="fa fa-trash-o fa-lg"></i></a> -->
                                    </td>
                                </tr>
                                <!-- #modal-dialog-delete -->
                                <div id="Del<?php echo $cuti['id_approval_cuti'] ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="center">
                                                <a href="index.php?page=delete-approval-tahunan-2&id_approval_cuti=<?= $cuti['id_approval_cuti'] ?>" class="btn btn-danger">&nbsp; &nbsp;YES&nbsp; &nbsp;</a>
                                            </div>
                                ...
                                <div id="Approve<?php echo $cuti['id_approval_cuti'] ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body" align="center">
                                                ...
                                                <br>
                                                <a href="index.php?page=status-cuti-tahunan-2&true=true&id_approval_cuti=<?= $cuti['id_approval_cuti'] ?>" class="btn btn-success">&nbsp; &nbsp;SETUJU&nbsp; &nbsp;</a>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Cancel</a>
                                            </div>
                                ...
                                <!-- #modal-dialog-reject -->
                                <div id="Reject<?php echo $cuti['id_approval_cuti'] ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body" align="center">
                                                <p>Mohon periksa kembali data pengajuan cuti terlampir. Pastikan semua informasi telah <span class="label label-primary">SESUAI</span> !</p>
                                                <br>
                                                <a href="index.php?page=status-cuti-tahunan-2&false=false&id_approval_cuti=<?= $cuti['id_approval_cuti'] ?>" class="btn btn-danger">&nbsp; &nbsp;YA&nbsp; &nbsp;</a>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Cancel</a>
                                            </div>
                                ...
                                <div id="Detail<?php echo $cuti['id_approval_cuti'] ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">
                                                    ...
                                                    Detail Pengajuan Cuti Tahunan ID_<?php echo $cuti['id_approval_cuti'] ?>
                                                </h4>
                                            </div>
                                            <div class="col-sm-12">
            ...
            <div class="tab-pane fade" id="izin">
                <div class="alert alert-success fade in">
                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span></button>
                    <i class="fa fa-info fa-2x pull-left"></i> Folder ini dapat digunakan untuk melihat data approval izin tahap 2 ......
                </div>
                <div class="table-responsive">
                    <table id="" class="table table-striped table-bordered nowrap display" width="100%">
                        <thead>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="center">
                                                ...
                                                <br>
                                                <a href="index.php?page=status-cuti-umum-2&true=true&id_approval_umum=<?= $izin['id_approval_umum'] ?>" class="btn btn-success">&nbsp; &nbsp;SETUJU&nbsp; &nbsp;</a>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Cancel</a>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="center">
                                                <p>Mohon periksa kembali data pengajuan izin terlampir. Pastikan semua informasi telah <span class="label label-primary">SESUAI</span> !</p>
                                                <br>
                                                <a href="index.php?page=status-cuti-umum-2&false=false&id_approval_umum=<?= $izin['id_approval_umum'] ?>" class="btn btn-danger">&nbsp; &nbsp;YA&nbsp; &nbsp;</a>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Cancel</a>
                                            </div>
