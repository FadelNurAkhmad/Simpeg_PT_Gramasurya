...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Riwayat <small>Orang Tua <i class="fa fa-angle-right"></i> Edit <i class="fa fa-key"></i> Pegawai: <?= $peg['pegawai_nama'] ?></small></h1>
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
	<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select name="status_hub" class="default-select2 form-control">
								...
								<option value="Ibu Kandung" <?php echo ($data['status_hub'] == 'Ibu Kandung') ? "selected" : ""; ?>>Ibu Kandung
							</select>
						</div>
					</div>
					<div class="form-group">
