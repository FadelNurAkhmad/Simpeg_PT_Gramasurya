...
<div class="invoice">
    <div class="invoice-company">
        <span class="pull-right hidden-print">
            ...
            <a href="../../pages/pegawai/cuti/tahunan_cuti/print-cuti.php?id_cuti=<?= $id_cuti ?>" target="_blank" title="print" class="btn btn-sm btn-success m-b-10"><i class="fa fa-print"></i> &nbsp;Print</a>
        </span>
        Detail Cuti Pegawai
    </div>
