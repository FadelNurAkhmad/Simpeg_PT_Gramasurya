...
<div class="invoice">
    <div class="invoice-company">
        <span class="pull-right hidden-print">
            ...
            <a href="../../pages/pegawai/gaji/print-detail-konfigurasi-slip-gaji.php?id_gaji_konfig=<?= $id_gaji_konfig ?>" target="_blank" title="print" class="btn btn-sm btn-success m-b-10"><i class="fa fa-print"></i> &nbsp;Print</a>
        </span>
        PT Gramasurya
    </div>
